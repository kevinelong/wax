...
SOURCE_SCRIPTS_DIR="$PROJECT_DIR/$PROJECT_NAME/$WAX_SCRIPTS_DIR"
...
if [ $WAX_COMPILE_SCRIPTS ]; then
  ...
  lua "$PROJECT_DIR/$PROJECT_NAME/wax/lib/build-scripts/luac.lua" wax wax.dat "$PROJECT_DIR/$PROJECT_NAME/wax/lib/stdlib/" "$PROJECT_DIR/$PROJECT_NAME/wax/lib/stdlib/init.lua" -L "$PROJECT_DIR/$PROJECT_NAME/wax/lib/stdlib"/**/*.lua
  ...
  cp -r "$PROJECT_DIR/$PROJECT_NAME/wax/lib/stdlib" "$DESTINATION_SCRIPTS_DIR/wax"
